...
##                            raise FriezeError('Incorrect input.')
    ...
    def analyse(self):
        ...
        period=int(period)
        flag1=self.judge_horizantal()
        flag2=self.judge_vertical()
        flag3=self.judge_glided_horizontal()
        flag4=self.judge_rotation()
...
##            print(temp[i])
    ...
    def judge_glided_horizontal(self):
        period=0
        temp=self.find_matrix()
        flag=True
        length=len(temp)
